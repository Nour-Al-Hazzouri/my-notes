...
- **Software Definition**: Intangible instructions that tell hardware what to do
- **Hardware vs. Software**: Hardware is physical components; software is intangible instructions
...
- **System Software**: Maintains core system functionality
  - Examples: Operating system tools and utilities
...
- **Compiled Languages**:
  - Uses human-readable instructions
  - Processes through a compiler to create machine-executable code
  - Compiler translates entire program before execution

- **Interpreted Languages**:
  - Not compiled ahead of time
  - Code stored in script files
  - Interpreter translates code into CPU instructions at runtime
  - More flexible but typically slower than compiled code
