...
- Finally, we will be discussing _SQL_ or _Structured Query Language_, a domain-specific way by which we can interact with and modify data.
...
- While relational databases have the ability to be faster and more robust than utilizing a `CSV` file, data can be optimized within a table using _indexes_.
...
---
**Previous**: [[Education/Career Paths/Web Development/2- New/1- CS50x/7- Week 6/3- Week 6 Section|Week 6 Section: Introduction to Python]] | **Next**: [[Education/Career Paths/Web Development/2- New/1- CS50x/8- Week 7/2- Week 7 Short|Week 7 Short: SQL]]
