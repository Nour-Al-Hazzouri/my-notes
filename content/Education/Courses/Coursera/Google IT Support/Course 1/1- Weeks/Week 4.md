...
- **Internet vs. World Wide Web**:
  ...
  - World Wide Web: Information on the internet accessed through browsers
- **Internet Access Methods**: Web browsers, email, chat, file-sharing programs
- **Internet Structure**:
  - Composed of satellites, cellular networks, and physical cables
  - Servers connect directly to the internet and store websites
  - Clients (phones, laptops) request content from servers
  - Clients connect to Internet Service Providers (ISPs)
...
- **Data Packets**:
  - All data (images, text, music) broken into small packets for transmission
  - Packets travel through multiple points to reach destination
  - Upon arrival, packets rearrange in correct order
...
- **Purpose**: Ensure packets are routed efficiently, uncorrupted, secure, and properly addressed
...
- **URL (Uniform Resource Locator)**: Web address format (e.g., www.reddit.com)
  ...
  - Domain endings (.com, .edu): Indicate website type
- **ICANN**: Internet Corporation for Assigned Names and Numbers (registers domains)
- **DNS (Domain Name System)**:
  - Maps human-readable domain names to IP addresses
  - Functions as the internet's directory
...
- **Solutions**:
  - IPv6: 128-bit addresses providing vastly more possible addresses
