...
**Example**: When multiplying 34 × 10, the digits 3 and 4 shift one place to the left, resulting in 340. Similarly, 34 × 100 = 3,400 and 34 × 1,000 = 34,000. This pattern extends to any multiple of powers of 10.
...
```
    ...
    Original number:  3 4
                      ↓ ↓
    After × 1,000:  3 4 0 0 0
    
    Pattern: When multiplying by 10ⁿ, add n zeros to the end
```
...
**Example**: To multiply 24 × 6 using an area model, we create a rectangle with sides of 24 and 6. We can break 24 into 20 + 4, creating two regions: 20 × 6 = 120 and 4 × 6 = 24. The total area (and product) is 120 + 24 = 144.

```
    Area Model for 24 × 6 = 144
    
    Breaking 24 into 20 + 4:
...
```
    Distributive Property: 7 × 23 = 161
...
**Example**: When multiplying 47 × 6, we start with 6 × 7 = 42. We write 2 in the ones place and regroup 4 tens. Then we calculate 6 × 4 = 24 tens, plus the regrouped 4 tens, giving 28 tens. The final product is 282.

```
    Multiplying with Regrouping: 47 × 6 = 282
    ...
    1. Multiply ones: 6 × 7 = 42
       Write 2 in ones place, regroup 4 tens
    
    2. Multiply tens: 6 × 4 = 24 tens
       Add regrouped 4 tens: 24 + 4 = 28 tens
       Write 28 in tens and hundreds places
...
4. Multiply 2 × 3 = 6 hundreds, write 6 in the hundreds place
5. Add the partial products: 238 + 680 = 918

```
    Multiplying 2-digit Numbers: 34 × 27 = 918
    ...
    -----
      ...
      6 8 0  (34 × 20)
    -----
      9 1 8  (Sum of partial products)
    
    Step-by-step process:
    
    1. Multiply 7 × 4 = 28
       Write 8, regroup 2 tens
    
    2. Multiply 7 × 3 = 21 tens
       Add regrouped 2 tens: 21 + 2 = 23 tens
       Write 238 for first partial product
    
    3. Multiply 2 × 4 = 8 tens
       Write 8 in tens place of second row
    
    4. Multiply 2 × 3 = 6 hundreds
       Write 6 in hundreds place
       Second partial product is 680
    
    5. Add partial products: 238 + 680 = 918
...
4. 30 × 20 = 600 (tens × tens)
5. Add all partial products: 24 + 120 + 120 + 600 = 864

```
    Partial Products Method: 36 × 24 = 864
    ...
    -----
      ...
      6 0 0   (30 × 20)
    -----
      8 6 4   (Sum of all partial products)
```
...
**Example**: To estimate 38 × 42, we might round to the nearest ten: 40 × 40 = 1,600. The exact product is 1,596, which is very close to our estimate, confirming that our calculation is reasonable.

```
    Estimation in Multiplication
    
    Example: Estimating 38 × 42
    
    Rounding to nearest ten:
    38 → 40
    42 → 40
    
    Estimated product: 40 × 40 = 1,600
    
    Exact product: 38 × 42 = 1,596
    
    The estimate (1,600) is very close to the exact product (1,596),
    confirming that our calculation is reasonable.
    
    Another example: Estimating 72 × 58
    
    Rounding to nearest ten:
    72 → 70
    58 → 60
    
    Estimated product: 70 × 60 = 4,200
    
    Exact product: 72 × 58 = 4,176
    
    The estimate (4,200) is close to the exact product (4,176),
    confirming that our calculation is reasonable.
```
