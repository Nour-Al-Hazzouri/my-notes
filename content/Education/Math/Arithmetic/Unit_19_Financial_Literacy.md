...
```
    ...
    Total: $1.00 + $0.25 + $0.05 + $0.03 = $1.33
...
```
    ...
    │ Salary        │ Fixed regular payment (usually annual)│
    │ Commission    │ Payment based on sales or performance │
    │ Tips          │ Additional payment for service        │
    │ Interest      │ Payment for lending money             │
    │ Dividends     │ Payment from owning stocks            │
    │ Rental income │ Payment from property rental          │
    │ Royalties     │ Payment for use of intellectual       │
    │               │ property                              │
    └───────────────┴───────────────────────────────────────┘
    ...
    Weekly earnings = Hours × Rate
                    = 40 × $15
                    = $600
    
    Monthly earnings (4 weeks) = $600 × 4 = $2,400
    Annual earnings (52 weeks) = $600 × 52 = $31,200
    ...
    Total annual earnings = Salary + Bonus
                          = $50,000 + $2,500
                          = $52,500
    
    Monthly earnings = $52,500 ÷ 12 = $4,375
    Bi-weekly pay = $52,500 ÷ 26 = $2,019.23
```
...
```
    ...
    Goal: Save $5,000 for a vacation in 2 years (24 months)
    
    Monthly savings needed = $5,000 ÷ 24 = $208.33
...
```
    ...
    │               │ - Easy access (debit card, checks)    │
    │               │ - Little or no interest               │
    ├───────────────┼───────────────────────────────────────┤
    │ Savings       │ - For setting aside money             │
    │               │ - Some access limitations             │
    │               │ - Earns interest                      │
    ├───────────────┼───────────────────────────────────────┤
    │ Certificate   │ - Fixed term deposit                  │
    │ of Deposit    │ - Limited access until maturity       │
    │ (CD)          │ - Higher interest rates               │
    ├───────────────┼───────────────────────────────────────┤
    │ Money Market  │ - Combination of checking and savings │
    ...
    Year 1: $1,000 × (1 + 0.02) = $1,020
    Year 2: $1,020 × (1 + 0.02) = $1,040.40
    Year 3: $1,040.40 × (1 + 0.02) = $1,061.21
    Year 4: $1,061.21 × (1 + 0.02) = $1,082.43
    Year 5: $1,082.43 × (1 + 0.02) = $1,104.08
    
    Visual representation:
    
    Growth of $1,000 at 2% Annual Interest
    ...
    Approximate years to double money = 72 ÷ Interest Rate
...
```
    ...
    ├───────────────┼───────────────────────────────────────┤
    │ Credit Cards  │ - Revolving credit line              │
    │               │ - High interest rates (15-25%)       │
    │               │ - Minimum monthly payments           │
    ├───────────────┼───────────────────────────────────────┤
    │ Personal Loans│ - Fixed amount and term              │
    │               │ - Fixed or variable interest rate    │
    │               │ - Regular payment schedule           │
    ├───────────────┼───────────────────────────────────────┤
    │ Mortgages     │ - Loans for real estate              │
    ...
    Total paid over 3 years = $152.11 × 36 = $5,475.96
    Total interest paid = $5,475.96 - $5,000 = $475.96
    ...
    - Interest = $1,000 × (0.18 ÷ 12) = $15
    - Principal reduction = $20 - $15 = $5
    - New balance = $1,000 - $5 = $995
    
    Month 2:
    - Minimum payment = $995 × 0.02 = $19.90
    - Interest = $995 × (0.18 ÷ 12) = $14.93
    - Principal reduction = $19.90 - $14.93 = $4.97
    - New balance = $995 - $4.97 = $990.03
    
    And so on...
    
    It would take approximately 93 months (7.75 years) to pay off,
    with total payments of about $1,800 (nearly double the original balance).
```
...
```
    ...
    ├───────────────┼───────────────────────────────────────┤
    │ Payroll Tax   │ - Tax for Social Security & Medicare  │
    │               │ - Percentage of wages                 │
    ...
    First $10,000 taxed at 10%: $10,000 × 0.10 = $1,000
    Next $30,000 taxed at 12%: $30,000 × 0.12 = $3,600
    Remaining $10,000 taxed at 22%: $10,000 × 0.22 = $2,200
    
    Total tax = $1,000 + $3,600 + $2,200 = $6,800
    
    Effective tax rate = $6,800 ÷ $50,000 = 13.6%
...
```
    Consumer Skills and Economic Decision-Making
    
    Comparison Shopping Example:
    
    Product A: $45 for 30 ounces
    Product B: $35 for 20 ounces
    
    Unit price calculation:
    
    Product A: $45 ÷ 30 = $1.50 per ounce
    Product B: $35 ÷ 20 = $1.75 per ounce
    
    Comparison: Product A is more economical ($1.50 < $1.75 per ounce)
    ...
    Option 1: Buy basic model now for $400
    Option 2: Save for premium model ($800) in 6 months
    
    Costs and Benefits Analysis:
    
    Option 1 (Basic Model Now):
    - Benefits: Immediate use, meets basic needs
    - Costs: $400, fewer features, may become outdated sooner
    
    Option 2 (Premium Model Later):
    - Benefits: Better features, longer useful life
    - Costs: $800, waiting 6 months without a new phone
    
    Opportunity Cost:
    - Choosing Option 1: Give up better features and longer life
    - Choosing Option 2: Give up immediate use and $400 to use elsewhere
    
    Decision factors to consider:
    - Current phone condition
    - Urgency of need
    - Budget constraints
    - Future value of features
    ...
    │ Concept       │ Description                           │
    ├───────────────┼───────────────────────────────────────┤
    │ Warranties    │ Guarantees for product quality/repair │
    │ Return Policies│ Terms for returning purchases         │
    │ Consumer Rights│ Legal protections for consumers       │
    │ Scam Awareness │ Recognizing and avoiding fraud        │
    └───────────────┴───────────────────────────────────────┘
```
