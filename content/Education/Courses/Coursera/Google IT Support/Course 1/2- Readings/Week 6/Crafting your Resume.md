...
- Focus on achievements using format: Action Verb + Specific Task + Quantifiable Point
  - Example: "Automated imaging process for new computers, reducing 90% of manual work for the IT team"
- Summarize responsibilities rather than listing routine tasks
...
- Example: Emphasize customer support experience for IT support roles, software development experience for programming jobs
...
- Provide in-depth accomplishments using same format as resume
- Include personal projects with tangible results (applications, websites)
