...
- **Origin**: Derived from the open-source ChromiumOS
...
- **Linux Applications**:
  - Added in 2018 (version 69 onwards)
  - Available on both ChromiumOS and ChromeOS
  - Implementation: Run in lightweight virtual machine
