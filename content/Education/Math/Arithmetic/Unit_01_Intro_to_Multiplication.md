...
**Example**: If there are 4 baskets, each containing 6 apples, we can find the total number of apples by multiplying 4 × 6 = 24 apples. Instead of counting each apple individually, we recognize that we have 4 equal groups with 6 items in each group.
...
```
    ...
    4 groups × 6 apples = 24 apples total
```
...
**Example**: 5 × 3 can be calculated as 3 + 3 + 3 + 3 + 3 = 15. Here, we're adding 3 five times, which is equivalent to multiplying 5 by 3.
...
**Example**: To represent 4 × 3 on a number line, we start at 0 and make 4 jumps of size 3, landing at positions 3, 6, 9, and finally 12. The product 4 × 3 = 12 is the final position.
...
**Example**: A 3 × 4 array has 3 rows and 4 columns, containing a total of 12 objects. This array visually represents the multiplication fact 3 × 4 = 12.
...
**Example**: 7 × 2 = 14 and 2 × 7 = 14. Although 7 groups of 2 and 2 groups of 7 represent different arrangements, they both result in the same total of 14.
