- Components:
	- React was released to be a component-based architecture
	...
	- Reusable
	- Independent
	- Simple ones are combined to make more complex ones
	- Each component has its own HTML, CSS, and JS logic
- Virtual DOM:
